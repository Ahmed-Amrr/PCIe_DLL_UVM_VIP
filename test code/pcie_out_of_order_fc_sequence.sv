`ifndef PCIE_OUT_OF_ORDER_FC_SEQUENCE_SV
`define PCIE_OUT_OF_ORDER_FC_SEQUENCE_SV

class pcie_out_of_order_fc_seq extends pcie_fc_init_seq;
    `uvm_object_utils(pcie_out_of_order_fc_seq)

    function new(string name = "pcie_out_of_order_fc_seq");
        super.new(name);
    endfunction : new
...
endclass : pcie_out_of_order_fc_seq
