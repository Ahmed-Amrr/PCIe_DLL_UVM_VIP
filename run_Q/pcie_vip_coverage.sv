...
class pcie_vip_coverage extends uvm_component;
    ...
    // State Coverage — all states and all legal transitions
        ...
        rx_type_c : coverpoint seq_item_rx.dllp[47:40]{
            ...
            bins INITFC1_P_D_b       = {INITFC1_P_D};
            bins INITFC1_NP_D_b      = {INITFC1_NP_D};
            bins INITFC1_CPL_D_b     = {INITFC1_CPL_D};
            bins INITFC2_P_b       = {INITFC2_P_D};
            bins INITFC2_NP_b      = {INITFC2_NP_D};
            bins INITFC2_CPL_b     = {INITFC2_CPL_D};
            bins UPDATEFC_P_b      = {UPDATEFC_P_D};
            bins UPDATEFC_NP_b     = {UPDATEFC_NP_D};
            bins UPDATEFC_CPL_b    = {UPDATEFC_CPL_D};
        }
        ...
        cp_dl_up_only : coverpoint state_seq_item.DL_Up {
            bins dl_up_1   = {1'b1};
            bins dl_up_0 = {1'b0};
        }
        cp_dl_down_only : coverpoint state_seq_item.DL_Down {
            bins dl_down_1   = {1'b1};
            bins dl_down_0 = {1'b0};
        }
        cx_dl_up_down : cross cp_dl_up_only, cp_dl_down_only {
            bins dl_up   = binsof(cp_dl_up_only.dl_up_1) && binsof(cp_dl_down_only.dl_down_0);
            bins dl_down   = binsof(cp_dl_up_only.dl_up_0) && binsof(cp_dl_down_only.dl_down_1);
            illegal_bins dl_up_dl_down_11 = binsof(cp_dl_up_only.dl_up_1) && binsof(cp_dl_down_only.dl_down_1); 
            illegal_bins dl_up_dl_down_00 = binsof(cp_dl_up_only.dl_up_0) && binsof(cp_dl_down_only.dl_down_0); 
        }
        // cx_dl_up_down : coverpoint {state_seq_item.DL_Up, state_seq_item.DL_Down} {
        //  bins dl_up   = {1'b1, 1'b0};
        //  bins dl_down = {1'b0, 1'b1};
        // }
        ...
        cp_dl_down_reported_inactive: cross cp_state, cx_dl_up_down {
            bins dl_down_inactive = binsof(cp_state.dl_inactive_b) && binsof(cx_dl_up_down.dl_down);
            option.cross_auto_bin_max = 0;
        }
        ...
        cp_dl_down_reported_feature: cross cp_state, cx_dl_up_down {
            bins dl_down_feature = binsof(cp_state.dl_feature_b) && binsof(cx_dl_up_down.dl_down);
            option.cross_auto_bin_max = 0;
        }
        ...
        cp_initfc1_received: coverpoint
            (seq_item_rx.dllp[47:40] inside {INITFC1_P_D, INITFC1_NP_D, INITFC1_CPL_D})
        ...
        cp_dl_down_reported_fc_init1: cross cp_state, cx_dl_up_down {
            bins dl_down_fc_init1 = binsof(cp_state.dl_init1_b) && binsof(cx_dl_up_down.dl_down);
            option.cross_auto_bin_max = 0;
        }
        ...
        {
            bins initfc1_seq = (INITFC1_P_D => INITFC1_NP_D => INITFC1_CPL_D);
        }
        ...
        // FCINIT2_01
        cp_dl_up_in_fc_init2 : cross cp_state, cx_dl_up_down{
            bins init2_DL_up = binsof(cp_state.dl_init2_b) && binsof(cx_dl_up_down.dl_up);
            option.cross_auto_bin_max = 0;
        }

        // FCINIT2_03
        cp_initfc2_sequence_order : coverpoint seq_item_rx.dllp[47:40] iff(state_seq_item.vip_state inside{DL_INIT2, DL_ACTIVE}) {
            bins seq_order_P_NP_CPL = (INITFC2_P_D => INITFC2_NP_D => INITFC2_CPL_D);
        }
