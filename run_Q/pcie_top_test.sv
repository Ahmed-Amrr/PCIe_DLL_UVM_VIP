...
class pcie_top_test_base extends uvm_test;
    ...
    function void configure_vip(ref pcie_vip_config cfg, string vip_mode);
        ...
        cfg.local_fc_credits_register.hdr_credits [FC_DEDICATED][FC_COMPLETION] = $random();
        cfg.local_fc_credits_register.data_credits[FC_DEDICATED][FC_COMPLETION] = $random();
        cfg.local_fc_credits_register.hdr_credits [FC_DEDICATED][FC_POSTED]     = $random();
        cfg.local_fc_credits_register.data_credits[FC_DEDICATED][FC_POSTED]     = $random();
        cfg.local_fc_credits_register.hdr_credits [FC_DEDICATED][FC_NON_POSTED] = $random();
        cfg.local_fc_credits_register.data_credits[FC_DEDICATED][FC_NON_POSTED] = $random();

        cfg.local_fc_credits_register.hdr_credits [FC_SHARED][FC_COMPLETION] = $random();
        cfg.local_fc_credits_register.data_credits[FC_SHARED][FC_COMPLETION] = $random();
        cfg.local_fc_credits_register.hdr_credits [FC_SHARED][FC_POSTED]     = $random();
        cfg.local_fc_credits_register.data_credits[FC_SHARED][FC_POSTED]     = $random();
        cfg.local_fc_credits_register.hdr_credits [FC_SHARED][FC_NON_POSTED] = $random();
        cfg.local_fc_credits_register.data_credits[FC_SHARED][FC_NON_POSTED] = $random();
            
        if (vip_mode == "P_infinite_credits") begin
            cfg.local_fc_credits_register.hdr_credits [FC_DEDICATED][FC_POSTED] = 0;
            cfg.local_fc_credits_register.data_credits[FC_DEDICATED][FC_POSTED] = 0;

            cfg.local_fc_credits_register.hdr_credits [FC_SHARED][FC_POSTED] = 0;
            cfg.local_fc_credits_register.data_credits[FC_SHARED][FC_POSTED] = 0;
        end
        else if (vip_mode == "NP_infinite_credits") begin
            cfg.local_fc_credits_register.hdr_credits [FC_DEDICATED][FC_NON_POSTED] = 0;
            cfg.local_fc_credits_register.data_credits[FC_DEDICATED][FC_NON_POSTED] = 0;

            cfg.local_fc_credits_register.hdr_credits [FC_SHARED][FC_NON_POSTED] = 0;
            cfg.local_fc_credits_register.data_credits[FC_SHARED][FC_NON_POSTED] = 0;
        end
        else if (vip_mode == "CPL_infinite_credits") begin
            cfg.local_fc_credits_register.hdr_credits [FC_DEDICATED][FC_COMPLETION] = 0;
            cfg.local_fc_credits_register.data_credits[FC_DEDICATED][FC_COMPLETION] = 0;

            cfg.local_fc_credits_register.hdr_credits [FC_SHARED][FC_COMPLETION] = 0;
            cfg.local_fc_credits_register.data_credits[FC_SHARED][FC_COMPLETION] = 0;
        end
