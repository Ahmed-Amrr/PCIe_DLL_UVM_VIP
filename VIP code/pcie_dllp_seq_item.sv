...
class pcie_dllp_seq_item extends uvm_sequence_item;
	...
	rand logic [47:0] dllp_pkg;		// 8 * 6bytes = 48 bits
	...
	// constraint Ack_c {
	// 	dllp_pkg [47:40] = 8'b0000_0000;			//type
	// 	dllp_pkg [39:28] = {12{1'b0}};				//reserved
	// }

	// // for NOP type no need for constraints as the datapayload is arbitrary value

	// constraint PM_c {
	// 	dllp_pkg [47:43] = 5'b0010_0;				//type
	// 	dllp_pkg [39:16] = {24{1'b0}};				//reserved
	// }

	// constraint Feature_c {
	// 	dllp_pkg [47:40] = 8'b0000_0010;
	// }
